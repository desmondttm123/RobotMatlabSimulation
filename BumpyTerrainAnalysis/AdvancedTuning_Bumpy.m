%% AdvancedTuning_Bumpy.m - Exhaustive F1 optimization on Bumpy Terrain data
% Same 10 experiments as AdvancedTuning.m but on bumpy terrain simulation data
...
%% Load data and build features (155 features)
fprintf('=== Advanced Tuning: Bumpy Terrain F1 Optimization ===\n\n');
...
% ====================================================================
% EXPERIMENT 1: RUSBoost 1000 cycles, deeper
% ====================================================================
...
% ====================================================================
% EXPERIMENT 2: RUSBoost stats-only (129-155)
% ====================================================================
exp_count = exp_count + 1;
fprintf('--- Exp %d: RUSBoost stats-only ---\n', exp_count);
feat_idx = 129:155;
tic;
...
% ====================================================================
% EXPERIMENT 3: Bagged Trees 1000 + 3x oversample
% ====================================================================
exp_count = exp_count + 1;
fprintf('--- Exp %d: Bagged Trees 1000 + oversample ---\n', exp_count);
...
% ====================================================================
% EXPERIMENT 4: AdaBoostM2 500 + oversample
% ====================================================================
exp_count = exp_count + 1;
fprintf('--- Exp %d: AdaBoostM2-500 ---\n', exp_count);
...
% ====================================================================
% EXPERIMENT 5: RUSBoost + Top-50 features
% ====================================================================
exp_count = exp_count + 1;
...
% ====================================================================
% EXPERIMENT 6: MLP [512-256-128-64]
% ====================================================================
exp_count = exp_count + 1;
...
% ====================================================================
% EXPERIMENT 7: Voting Ensemble
% ====================================================================
exp_count = exp_count + 1;
fprintf('--- Exp %d: Voting Ensemble ---\n', exp_count);
[X_bal, Y_bal] = oversample(X_train, Y_train, 0.02);
tic;
...
% ====================================================================
% EXPERIMENT 8: RUSBoost 2000 cycles, slow LR
% ====================================================================
exp_count = exp_count + 1;
fprintf('--- Exp %d: RUSBoost 2000, LR=0.01 ---\n', exp_count);
tic;
mdl = fitcensemble(X_train, Y_train, ...
    'Method', 'RUSBoost', ...
...
% ====================================================================
% EXPERIMENT 9: Two-Stage (SVM terrain + RUSBoost object)
% ====================================================================
exp_count = exp_count + 1;
fprintf('--- Exp %d: Two-Stage (SVM + RUSBoost) ---\n', exp_count);
tic;
[X_bal, Y_bal] = oversample(X_train, Y_train, 0.02);
...
% ====================================================================
% EXPERIMENT 10: Bagged Trees cost-sensitive
% ====================================================================
exp_count = exp_count + 1;
...
%% Summary
fprintf('\n============================================================\n');
fprintf('      BUMPY TERRAIN - ADVANCED TUNING RESULTS\n');
fprintf('============================================================\n');
...
%% Save
save(fullfile(output_dir, 'AdvancedTuningResults.mat'), 'exp_results');
fprintf('Results saved to: %s\n', fullfile(output_dir, 'AdvancedTuningResults.mat'));
